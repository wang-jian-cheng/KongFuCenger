...
#pragma mark - ///// //最下方回复部分
    ...
    for (int i = 0; i < ymData.replyDataSource.count; i ++ ) {
        ...
        _ilcoreText.frame = CGRectMake(offSet_X,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance + ymData.favourHeight + (ymData.favourHeight == 0?0:kReply_FavourDistance) + ([ymData.showVideoArray[0] isEqual:@""]?0:127), screenWidth - offSet_X * 2, [_ilcoreText getTextHeight]);
    ...
    if (ymData.replyDataSource.count == 0) {//没回复的时候
        ...
        replyImageView.frame = CGRectMake(offSet_X, backView_Y - 10 + balanceHeight + 5 + kReplyBtnDistance + ([ymData.showVideoArray[0] isEqual:@""]?0:127), 0, 0);
        ...
        _zanNum.frame = CGRectMake(screenWidth - offSet_X - 40 + 6 - 41 - 100,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 100, 15);
        _zanBtn.frame = CGRectMake(screenWidth - offSet_X - 40 + 6 - 40,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 18, 15);
        _vLine.frame = CGRectMake(screenWidth - offSet_X - 40 + 6 - 18,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 1, 15);
        _CommentBtn.frame = CGRectMake(screenWidth - offSet_X - 40 + 6 - 13,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 18, 15);
        _CommentBtnHF.frame = CGRectMake(screenWidth - offSet_X - 40 + 6 + 5,TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 40, 15);
        //_commentDate.frame = CGRectMake(offSet_X, replyImageView.frame.origin.y - 24, 100, 18);
        _commentDate.frame = CGRectMake(offSet_X, TableHeader + 10 + ShowImage_H + (ShowImage_H + 10)*(scale_Y/3) + origin_Y + hhhh + kDistance + (ymData.islessLimit?0:30) + balanceHeight + kReplyBtnDistance - 24+ ([ymData.showVideoArray[0] isEqual:@""]?0:127), 100, 18);
        
    }else{
        _videoImg.frame = CGRectMake(offSet_X, backView_Y - 10 + balanceHeight + 5 + kReplyBtnDistance - 24, screenWidth - 2 * offSet_X, 100);
        replyImageView.frame = CGRectMake(offSet_X, backView_Y - 10 + balanceHeight + 5 + kReplyBtnDistance + ([ymData.showVideoArray[0] isEqual:@""]?0:127), screenWidth - offSet_X * 2, backView_H + 20 - 8);//微调
