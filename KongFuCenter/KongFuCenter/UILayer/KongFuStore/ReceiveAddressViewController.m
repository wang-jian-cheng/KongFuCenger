...
-(void)setDefaultAddress:(UIButton *)btn{
    if(_receiveAddressType == Mode_SelectAddress){
        if ([self.delegate respondsToSelector:@selector(getReceiveAddress:)]) {
            ...
            [dict setValue:[Toolkit judgeIsNull:[receiveArray[btn.tag] valueForKey:@"ReceiverName"]] forKey:@"ReceiverName"];
            [dict setValue:[Toolkit judgeIsNull:[receiveArray[btn.tag] valueForKey:@"Phone"]] forKey:@"Phone"];
            [dict setValue:[NSString stringWithFormat:@"%@%@",[[Toolkit judgeIsNull:[receiveArray[btn.tag] valueForKey:@"Area"]] stringByReplacingOccurrencesOfString:@"/" withString:@""],[Toolkit judgeIsNull:[receiveArray[btn.tag] valueForKey:@"Address"]]] forKey:@"TotaleAddress"];
